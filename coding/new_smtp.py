...
def Send_email_text(subject, content, filepath, receive_email):
	...
	#     添加图片
	fp = open('../pythonspider/document/有你Offer.jpg', 'rb')
...
jpg_path = '../pythonspider/document/有你Offer.jpg'
# pdf_path = "c.pdf"
# txt_path = "d\\e\\f.txt"
xlsx_path = "../pythonspider/document/2019届校招内推汇总表（更新至{0}.{1}）-有你Offer出品.xlsx".format(now.split('-')[1].lstrip('0'), now.split('-')[2].lstrip('0'))
file_path = [xlsx_path]  #发送三个文件到两个邮箱
print(subject,xlsx_path)
receive_email1 = ['1831095906@qq.com']
...
sep0908 = ['yangxiaoxiaotom@163.com',
